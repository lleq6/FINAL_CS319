        ...
        <footer className="bottom bottom-0 bg-yellow-300 w-full py-8">
            <div className="grid grid-cols-4 text-center">
                <div className="mx-auto">
                    <Image className="mx-auto" src={"/kacha-icon.png"} alt="test" width={150} height={150}></Image>
                    <p>982 หมู่ 2 ต.ศาลาด่าน <br/> อ.เกาะลันตา จ.กระบี่</p>
            ...
            <h3 className="text-center text-xl">Copyright © 2024 ...... Designed by .......</h3>
        </footer>
    )
}
